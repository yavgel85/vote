...
>
    <div class="hidden md:block border-r border-gray-100 px-5 py-8">
        ...
        <div class="mt-8">
            ...
            @else
                <button wire:click.prevent="vote" class="w-20 bg-gray-300 border border-gray-300 hover:border-gray-400 font-bold text-xxs uppercase rounded-xl transition duration-150 ease-in px-4 py-3">Vote</button>
            @endif
        </div>
    </div>
...
{{--                {{ $idea->description }}--}}
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                    ...
                    <div>&bull;</div>
                    <div wire:ignore class="text-gray-900">{{ $idea->comments_count }} {{ Str::of('comment')->plural($idea->comments_count) }}</div>
                </div>
                <div
                    x-data="{ isOpen: false }"
                ...
                <div class="flex items-center md:hidden mt-4 md:mt-0">
                    ...
                    @else
                        <button
                            wire:click.prevent="vote"
                            class="w-20 bg-gray-200 border border-gray-300 font-bold text-xxs uppercase rounded-xl hover:border-gray-400 transition duration-150 ease-in px-4 py-3 -mx-5"
                        >
                            Vote
                        </button>
                    @endif
