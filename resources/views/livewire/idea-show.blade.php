<div class="idea-and-buttons container">
            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                        ...
                        <div>&bull;</div>
                        <div class="text-gray-900">{{ $comments_count = $idea->comments()->count() }} {{ Str::of('comment')->plural($comments_count) }}</div>
                    </div>
                    <div
                        x-data="{ isOpen: false }"
                        ...
                        <div class="relative">
                            ...
                            >
                                <svg fill="currentColor" width="24" height="6">
                                    <path d="M2.97.061A2.969 2.969 0 000 3.031 2.968 2.968 0 002.97 6a2.97 2.97 0 100-5.94zm9.184 0a2.97 2.97 0 100 5.939 2.97 2.97 0 100-5.939zm8.877 0a2.97 2.97 0 10-.003 5.94A2.97 2.97 0 0021.03.06z" style="color: rgba(163, 163, 163, .5)"></path>
                                </svg>
                            </button>
                            <ul
                                x-cloak
                            ...
                            >
                                @can('update', $idea)
                                <li>
                                    <a href="#" class="hover:bg-gray-300 block transition duration-150 ease-in px-5 py-3"
                                        @click.prevent="
                                        isOpen = false
                                ...
                                @if ($idea->spam_reports > 0)
                                    <li>
                                        <a href="#"
                                            ...
                                            class="hover:bg-gray-300 block transition duration-150 ease-in px-5 py-3"
                                        >
                                            Not Spam
                                        </a>
                                    </li>
    ...
    <div class="buttons-container flex items-center justify-between mt-6">
        <div class="flex flex-col md:flex-row items-center justify-between space-x-4 md:ml-6">
        ...
        <div class="hidden md:flex items-center justify-between space-x-3">
            ...
            @else
                <button
                    type="button"
                    wire:click.prevent="vote"
                    class="w-32 h-11 text-xs bg-gray-300 font-semibold uppercase rounded-xl border border-gray-300 hover:border-gray-400 transition duration-150 ease-in px-6 py-3"
                >
                    <span>Vote</span>
                </button>
            @endif
