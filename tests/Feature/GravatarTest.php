...
class GravatarTest extends TestCase
{
    ...
    {
        $user = User::factory()->create(['email' => 'afakeemail@fakeemail.com',]);
    ...
    {
        $user = User::factory()->create(['email' => 'zfakeemail@fakeemail.com',]);
    ...
    {
        $user = User::factory()->create(['email' => '0fakeemail@fakeemail.com',]);
    ...
    {
        $user = User::factory()->create(['email' => '9fakeemail@fakeemail.com',]);
